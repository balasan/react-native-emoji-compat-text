/**
 * Copyright (c) Bankify Ltd and its affiliates.
 * This file is implemented base on ReactTextView.java from Facebook's React
 * Native
...
public class RNEmojiCompatTextView extends EmojiAppCompatTextView implements ReactCompoundView {
  ...
  public RNEmojiCompatTextView(Context context) {
    super(context);
